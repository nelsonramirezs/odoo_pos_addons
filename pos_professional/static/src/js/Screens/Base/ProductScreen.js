// BiProductScreen js
odoo.define('pos_professional.productScreen', function(require) {
	"use strict";
							...
							if (allow_order == false)
							{
								if ( (output[0][1] <= deny_order) || (output[0][1] <= 0) )
								{
									...
									self.showPopup('ErrorPopup', {
										...
										body: self.env._t("Deny Order" + "(" + product.display_name + ")" + " está agotado."),
									});
								}
							}
						...
						if (product.type == 'product' && allow_order == false)
						{
							...
							else if (product.qty_available <= 0 && allow_order == false)
							{
								...
								self.showPopup('ErrorPopup', {
									...
									body: self.env._t("(" + product.display_name + ")" + " está agotado."),
								});
							}
						}
