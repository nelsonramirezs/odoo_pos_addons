# -*- coding: utf-8 -*-
# Part of Pronexo. See LICENSE file for full copyright and licensing details.
...
class pos_config(models.Model):
	...
	pos_session_limit = fields.Selection([('all',  "Load all Session's Orders"), ('last3', "Load last 3 Session's Orders"), ('last5', " Load last 5 Session's Orders"),('current_day', "Solo pedidos del día actual"), ('current_session', "Solo pedidos de la sesión actual")], string='Session limit',default="current_day")
